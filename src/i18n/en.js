export default {
  ...
  button: {
    ...
    upload: {
      gcodes: {
        ...
        title:
          "Upload one or more G-Code files (drag&drop is supported as well)",
      },
      start: {
        caption: "Upload & Start",
        title:
          "Upload & Start one or more G-Code files (drag&drop is supported as well)",
      },
      macros: {
        caption: "Upload Macro File(s)",
        title:
          "Upload one or more macro files (drag&drop is supported as well)",
      },
      filaments: {
        caption: "Upload Filament Configs",
        title:
          "Upload one or more filament configurations (drag&drop is supported as well)",
      },
      menu: {
      ...
      system: {
        ...
        title:
          "Upload one or more system files (drag&drop is supported as well)",
      },
      web: {
  ...
  dialog: {
    ...
    connect: {
      ...
      prompt:
        "Please enter the hostname and password of the machine that you would like to connect to:",
    ...
    factoryReset: {
      ...
      prompt:
        "Are you sure you wish to perform a factory reset? All saved settings will be lost.",
    },
    filament: {
    ...
    fileEdit: {
      ...
      save: "Save",
      confirmClose:
        "The file has been changed. If you proceed, your changes will be lost.",
    },
    fileTransfer: {
    ...
    update: {
      ...
      prompt:
        "You have uploaded at least one firmware update. Would you like to install them now?",
      resetTitle: "Reset firmware?",
      resetPrompt:
        "You have just installed expansion board updates. Do you want to reboot the main controller to restore the previous configuration?",
    },
  ...
  notification: {
    ...
    deleteFilament: {
      ...
      errorStillLoaded:
        "At least one of the selected filaments is still loaded. Please unload them before you proceed",
      errorSubDirectories:
        "The filament {0} contains sub-directories. Please delete them manually and try again.",
    },
    download: {
    ...
    renameFilament: {
      ...
      errorStillLoaded:
        "This filament is still loaded. Please unload it before you proceed",
    },
  ...
  panel: {
    ...
    movement: {
      ...
      axesNotHomed:
        "The following axis is not homed:|The following axes are not homed:",
      noAxes: "No Axes",
    },
    settingsAbout: {
      caption: "About",
    ...
    settingsAppearance: {
      ...
      binaryFileSizesTitle:
        "File sizes are displayed with a basis of 1024 (IEC) instead of 1000 (SI)",
      disableAutoComplete: "Disable auto-completion",
      disableAutoCompleteTitle:
        "Do not show auto-complete list when typing in code or temperature inputs",
    },
  ...
  plugins: {
    ...
    gcodeViewer: {
      ...
      reloadView: {
        caption: "Reload View",
        title:
          "Reload the current gcode, this is used when changing settings like color, feedrate color, etc.",
      },
      loadCurrentJob: {
      ...
      renderQuality: {
        ...
        title:
          "Adjust the visualization quality of the viewer. The higher the level the more vertices and render modes become available",
      },
      sbc: "SBC",
      low: "Low",
      medium: "Medium",
      ...
      renderMode: {
        ...
        title:
          "Render mode allows you to set extruder color or feedrate line coloring in the viewer",
      },
      color: "Color",
      feedrate: "Feedrate",
