export default {
  ...
  button: {
    ...
    upload: {
      gcodes: {
        ...
        title:
          "Eine oder mehr G-Code-Dateien hochladen (Drag&Drop wird ebenfalls unterstützt)",
      },
      start: {
        caption: "Hochladen & Starten",
        title:
          "Eine G-Code-Datei hochladen und starten (Drag&Drop wird ebenfalls unterstützt)",
      },
      macros: {
        caption: "Makro(s) Hochladen",
        title:
          "Eine oder mehr Makrodateien hochladen (Drag&Drop wird ebenfalls unterstützt)",
      },
      filaments: {
        caption: "Filamentkonfiguration Hochladen",
        title:
          "Eine oder mehr Filamentkonfigurationen hochladen (Drag&Drop wird ebenfalls unterstützt)",
      },
      menu: {
        caption: "Menüdatei(en) hochladen",
        title:
          "Eine oder mehr Menüdateien hochladen (Drag&Drop wird ebenfalls unterstützt)",
      },
      system: {
        caption: "Systemdatei(en) hochladen",
        title:
          "Eine oder mehr Systemdateien hochladen (Drag&Drop wird ebenfalls unterstützt)",
      },
      web: {
        caption: "Webdatei(en) hochladen",
        title:
          "Eine oder mehr Webdateien hochladen (Drag&Drop wird ebenfalls unterstützt)",
      },
      update: {
        caption: "Update(s) hochladen",
        title:
          "Ein oder mehr Updates hochladen und installieren (Drag&Drop wird ebenfalls unterstützt)",
      },
    },
  },
  chart: {
  ...
  dialog: {
    changeMoveStep: {
      ...
      prompt:
        "Bitte geben Sie einen neuen Wert für den angeklickten Bewegungsbutton ein:",
    },
    configUpdated: {
      title: "Board neu starten?",
      prompt:
        "Möchten Sie das Board neu starten um die aktualisierte Konfiguration zu übernehmen?",
    },
    connect: {
      title: "Zu Maschine verbinden",
      prompt:
        "Bitte geben Sie den Hostnamen und das Passwort der Maschine ein, zu der Sie verbinden möchten:",
    ...
    editExtrusionAmount: {
      ...
      prompt:
        "Bitte geben Sie eine neue Menge für den angeklickten Button ein:",
    },
    editExtrusionFeedrate: {
      title: "Extrusionsgeschwindigkeit bearbeiten",
      prompt:
        "Bitte geben Sie eine neue Vorschubrate für den angeklickten Button ein:",
    },
    factoryReset: {
      title: "Auf Werkseinstellungen zurücksetzen?",
      prompt:
        "Sind Sie sicher, dass sie einen Reset auf Werkseinstellungen durchführen möchten? Alle gespeicherten Einstellungen gehen dabei verloren.",
    },
    filament: {
    ...
    fileEdit: {
      ...
      save: "Speichern",
      confirmClose:
        "Die Datei wurde geändert. Wenn Sie fortfahren gehen Ihre Änderungen verloren.",
    },
    fileTransfer: {
    ...
    update: {
      ...
      prompt:
        "Sie haben gerade mindestens ein Firmwareupdate hochgeladen. Möchten Sie diese jetzt installieren?",
      resetTitle: "Firmware zurücksetzen?",
      resetPrompt:
        "Sie haben gerade Updates für Erweiterungsboards installiert. Möchten Sie den Hauptcontroller jetzt neustarten um die vorige Konfiguration wiederherzustellen?",
    },
  ...
  error: {
    ...
    disconnected:
      "Konnte die Aktion nicht beenden weil die Verbindung getrennt worden ist",
    ...
    uploadStartWrongFileCount:
      "Nur eine einzige Datei kann hochgeladen und gestartet werden",
    uploadNoSingleZIP:
      "Es kann nur eine einzige ZIP-Datei auf einmal hochgeladen werden",
    uploadNoFiles: "Dieses ZIP enthält keine brauchbaren Dateien",
    codeResponse:
      "Konnte Code nicht ausführen weil eine ungültige Antwort empfangen wurde",
    codeBuffer:
      "Konnte Code nicht ausführen weil der Pufferplatz aufgebraucht ist",
  ...
  notification: {
    ...
    delete: {
      ...
      errorMessageDirectory:
        "Bitte stellen Sie sicher, dass das ausgewählte Verzeichnis leer ist",
    ...
    deleteFilament: {
      ...
      errorStillLoaded:
        "Mindestens eins der ausgewählten Filamente ist noch geladen. Bitte erst entladen bevor Sie fortfahren",
      errorSubDirectories:
        "Das Filament {0} enthält Unterverzeichnisse. Bitte löschen Sie diese erst händisch und versuchen Sie es erneut",
    },
    download: {
    ...
    renameFilament: {
      ...
      errorStillLoaded:
        "Dieses Filament ist noch geladen. Bitte erst entladen bevor Sie fortfahren",
    },
  ...
  panel: {
    ...
    movement: {
      ...
      axesNotHomed:
        "Die folgende Achse ist nicht referenziert:|Die folgenden Achsen sind nicht referenziert:",
      noAxes: "Keine Achsen",
    },
    settingsAbout: {
      caption: "Über",
    ...
    settingsAppearance: {
      ...
      binaryFileSizesTitle:
        "Dateigrößen werden mit einer Basis von 1024 (IEC) statt 1000 (SI) angezeigt",
      disableAutoComplete: "Autovervollständigung deaktivieren",
      disableAutoCompleteTitle:
        "Keine Autovervollständigung bei der Eingabe von Codes oder Temperaturen anzeigen",
    },
    settingsCommunication: {
      ...
      fileTransferRetryThreshold:
        "Grenzwert für erneute Versuche von Dateiübetragungen ({0})",
    ...
    settingsElectronics: {
      ...
      updateNote:
        "Hinweis: Sie können Aktualisierungen auf der System-Seite installieren.",
    },
    settingsEndstops: {
    ...
    settingsGeneral: {
      ...
      settingsSaveDelay:
        "Verzögerung bevor Einstellungen gesichert werden ({0})",
      cacheStorageLocal: "Zwischenspeicher im lokalen Speicher sichern",
      cacheSaveDelay:
        "Verzögerung bevor der Zwischenspeicher gesichert wird ({0})",
    },
    settingsListItems: {
    ...
    settingsNotifications: {
      ...
      notificationErrorsPersistent:
        "Fehlermeldungen nicht automatisch schließen",
    ...
    settingsWebcam: {
      ...
      webcamLiveURL:
        "URL, die geöffnet werden soll, wenn auf das Webcam-Bild geklickt wird (optional)",
      webcamFix:
        "Keinen extra HTTP-Qualifizierer beim Neuladen der Bilder anhängen",
  ...
  plugins: {
    ...
    gcodeViewer: {
      ...
      reloadView: {
        ...
        title:
          "Aktuellen G-Code neu laden, muss benutzt werden wenn Einstellungen wie Farbe, Vorschubrate usw. geändert worden sind",
      },
      loadCurrentJob: {
      ...
      renderQuality: {
        ...
        title:
          "Darstellungsqualität der Ansicht anpassen. Je höher die Stufe desto mehr Details werden angezeigt",
      },
      sbc: "SBC",
      low: "Niedrig",
      medium: "Mittel",
      ...
      extruders: {
        caption: "Extruder",
        title:
          "Setzt die Farbe, die zur Darstellung eines Extruders genutzt wird",
      },
      tool: "Werkzeug {0}",
      ...
      renderMode: {
        ...
        title:
          "Mit dem Darstellungsmodus können die Farben der Extruder oder Vorschubgeschwindigkeiten geändert werden",
      },
      color: "Farbe",
      feedrate: "Feedrate",
      ...
      renderFailed:
        "Vorige Darstellung fehlgeschlagen. Ändere Darstellungsqualität auf SBC",
    },
    heightmap: {
